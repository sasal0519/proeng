# Referência de API — ProEng

Este documento descreve as classes, funções e interfaces principais do projeto ProEng.
...
## 9. Utilitários de Exportação

### 9.1 Função `_export_view`
