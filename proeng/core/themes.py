...
# ─── 14. DRACULA: Paleta oficial Dracula, escuro sofisticado, cores vibrantes ───
...
# Sequência de rotação de temas (14 temas).
_THEME_ORDER = [
    "neo_brutalist",
    "midnight",
    "embers",
