...
class W5H2Widget(QWidget):
    ...
    def _draw_diagram(self):
        ...
        for aid in self.nodes[1]["children"]:
            ...
            path = QPainterPath()
            path.moveTo(p1_root)
            path.lineTo(mid_x, p1_root.y())
            path.lineTo(mid_x, p2_action.y())
            path.lineTo(p2_action)
            ...
            for did in self.nodes[aid]["children"]:
                ...
                path2.lineTo(mid_x2, p1_action.y())
                path2.lineTo(mid_x2, p2_detail.y())
                path2.lineTo(p2_detail)
